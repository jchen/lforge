...
pred isNotRelated[x: Person, y: Person] {
    ...
    -- not reachable[y, x, parent1, parent2]
}
...
-- While it can fun to test this for more people your solution should
