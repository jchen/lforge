...
\emph{\color{OliveGreen} The following is a summary of some of the sources and related work I've found: I still need to write this section.}\todo{write this section}
...
\begin{itemize}
    ...
    \item \cite{srajesh-honorsthesis,lzhu-honorsthesis} uses Forge to verify privacy policies. But oftentimes this task is made faster within a `real' programming language.\todo{change this?}\todo{more examples of alloy}
\end{itemize}}
