...
\begin{tikzpicture}[
    ...
    \node (n1) [NTRC,label={\texttt{\tiny TSyntax `forge_program}},fill=forgelistingcolor,rounded corners=3pt] {Forge Syntax};
    ...
    \path (n2) to [L,"Translation"] (n3);
    \path (n3) to [L,"Elab/Eval"] (n4);
